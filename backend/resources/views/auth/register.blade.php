...
<x-head :title="'Admin Register'" :description="'Admin dashboard register page'" :author="'Palet-design'" />
                            ...
                            <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('register') }}" class="my-4">
                                        ...
                                        {{-- <div class="form-group d-flex mb-3">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <a class='text-muted fs-14' href='{{ route('password.request') }}'>パスワードを忘れましたか?</a>
                                            </div>
                                        </div> --}}
                                    ...
                                    <div class="text-center text-muted mb-4">
                                        <p class="mb-0">既にアカウントを持っていますか?<a class='text-primary ms-2 fw-medium'
                                                href='{{ route('login') }}'>ログイン</a></p>
                                    </div>

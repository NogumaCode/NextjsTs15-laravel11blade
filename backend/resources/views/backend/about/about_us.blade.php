            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.aboutus') }}" method="post" class="row g-3"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="setup_growth" class="form-control"
                                        value="{{ $about->setup_growth }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">Problem Solving</label>
                                    <input type="text" name="problem_solving" class="form-control"
                                        value="{{ $about->problem_solving }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">Passive Income</label>
                                    <input type="text" name="passive_income" class="form-control"
                                        value="{{ $about->passive_income }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">Goal Achiever</label>
                                    <input type="text" name="goal_achiever" class="form-control"
                                        value="{{ $about->goal_achiever }}">
                                </div>

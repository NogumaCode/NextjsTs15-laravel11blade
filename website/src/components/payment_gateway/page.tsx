          ...
          <div className="container w-full lg:py-[150px] pt-14 py-16">
            <div className="w-full flex items-center lg:justify-end " ref={ref}>
              ...
              >
                ...
                <div className="text-button">Trusted by 5M+ People<br/>Around the glove </div>
                </div>
                ...
                <div className="button-block flex items-center max-sm:flex-wrap sm:gap-6 gap-3 lg:mt-12 mt-8 w-fit">
                  <Link className="button-main box-shadow bg-blue-700 hover:bg-bl text-white bg-blue whitespace-nowrap rounded-full" href="/">
                  Get Started
                  </Link>
                  <div className="relative">
                    ...
                    <span className="whitespace-nowrap">(00) 123 123 456</span></Link>
                    <Image src='/images/component/gateway1-dot.png' className="absolute -right-12 w-[100px] h-auto top-1/2 -translate-y-1/2" width={4000} height={4000} alt='img' />
                  </div>
                </div>
              </div>
            </div>
